...
<head>
    ...
    <style>
      body { font-family: 'Montserrat', sans-serif; background: #F5F8FA; }
      html { scroll-behavior: smooth; }
      .modelo-title { color: #1A3A4F; font-weight: 700; letter-spacing: 0.5px; }
      .modelo-card {
        background: #fff;
        border-radius: 18px;
        box-shadow: 0 2px 12px 0 rgba(25,118,165,0.04);
      ...
      .modelo-btn:hover { background: #14577c; }
      .modelo-btn-green {
        background: #5ED6C0;
        color: #fff;
        border-radius: 24px;
      ...
      .modelo-btn-green:hover { background: #4FC3A1; }
      .modelo-icon {
      ...
      .modelo-faq-box {
        ...
        box-shadow: 0 2px 8px 0 rgba(25,118,165,0.04);
      }
      .hero-bg {
        min-height: 100vh;
        height: 100vh;
        background: radial-gradient(circle at 0% 0%, rgba(25,118,165,0.97) 0%, rgba(25,118,165,0.7) 30%, rgba(25,118,165,0.0) 60%), url('/img/hero.jpg');
      ...
      .hero-content {
        ...
        margin-left: 17vw;
        margin-bottom: 22vh;
        background: rgba(25,60,100,0.82);
        border-radius: 18px;
        padding: 2.2rem 1.5rem 2.2rem 1.2rem;
        box-shadow: 0 2px 12px 0 rgba(25,118,165,0.10);
      }
      ...
      .hero-btn {
        ...
        transition: background 0.2s;
        box-shadow: 0 2px 8px 0 rgba(25,118,165,0.10);
        border: none;
        margin-top: 0.5rem;
      }
      .hero-btn:hover {
...
const opcoes = document.getElementById('canais-opcoes');
let aberto = false;
btnCanais.onclick = (e) => {
  e.stopPropagation();
  aberto = !aberto;
  opcoes.style.display = aberto ? 'flex' : 'none';
};
document.addEventListener('click', (e) => {
  if (aberto && !btnCanais.contains(e.target)) {
